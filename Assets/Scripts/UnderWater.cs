...
public class UnderWater : MonoBehaviour {
	...
	void Update () {
        if (transform.position.x >= 4663.53 && transform.position.x <= 5061.121 && transform.position.z >= -729.498 && transform.position.z <= -331.1509) {
            if ((transform.position.y <= lakeWater.transform.position.y) != isUnderWater) {
                isUnderWater = transform.position.y < lakeWater.transform.position.y;
                if (isUnderWater) {
                    setUnderWater();
                }
                if (!isUnderWater) {
        ...
        if (transform.position.x >= 345.55 && transform.position.x <= 638.3987 && transform.position.z >= -617.4688 && transform.position.z <= -320.8628) {
            if ((transform.position.y <= riverWater.transform.position.y) != isUnderWater) {
                isUnderWater = transform.position.y < riverWater.transform.position.y;
                if (isUnderWater) {
                    setUnderWater();
                }
                if (!isUnderWater) {
        ...
        if (transform.position.x >= 58.27055 && transform.position.x <= 655.674 && transform.position.z >= 3856.067 && transform.position.z <= 4453.523) {
            if ((transform.position.y <= oceanWater.transform.position.y - 1) != isUnderWater) {
                isUnderWater = transform.position.y < oceanWater.transform.position.y;
                if (isUnderWater) {
                    setUnderWater();
                }
                if (!isUnderWater) {
